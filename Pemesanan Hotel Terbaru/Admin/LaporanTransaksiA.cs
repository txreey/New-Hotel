...
namespace Pemesanan_Hotel_Terbaru.Admin
{
    public partial class LaporanTransaksiA : Form
    {
        ...
        public LaporanTransaksiA()
        {
            ...
            guna2LaporanTransaksi.Click += (s, e) => { LoadLaporanTransaksiAdmin(); }; // Refresh
        ...
        private void ApplyElegantTheme()
        {
            ...
            guna2HtmlLabel8.ForeColor = ColorTranslator.FromHtml("#333333"); // Admin

            // Tombol Aksi (Emas & Abu)
            ...
            // Highlight Laporan Transaksi (Aktif)
        ...
        private void DisplayData(DataTable dt)
        {
            ...
            // 3. Fix Tampilan Tabel (Header Emas)
            FixTableStyle();
        }
            ...
            try
            {
                ...
                if (save.ShowDialog() == DialogResult.OK)
                {
                    using (var wb = new XLWorkbook())
                    {
                        ...
                        // Hitung Total (Kolom Total ada di index ke-8 dlm DataTable)
                        decimal total = 0;
